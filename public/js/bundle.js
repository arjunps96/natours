...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJqdW5wcyIsImEiOiJja3A0NWdvYXIyYXk4MnBtcHB6b2U2NmljIn0.2obpha1JDO6t6CrQy19wog';
...
var stripe = Stripe('pk_test_51IwkPeSCb7t0ilC0iJ4RLkGY45S1IteIFiLRa4HShYbgVjWd6Rw1lLQqEh3Nt6xxALQby87VjkNcpsqZm5Kl2JuE00B8RD1JAh');
...
var updateDataEl = document.querySelector('.form-user-data');
var updatePassEl = document.querySelector('.form-user-settings');
var bookTourEl = document.getElementById('book-tour');
...
if (updateDataEl) {
  updateDataEl.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (updatePassEl) {
  updatePassEl.addEventListener('submit', /*#__PURE__*/function () {
